// Site Header (copy) - Updated July 20, 2024
function noop() { }
const identity = x => x;
...
function create_else_block_1(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*hovered_link*/ ctx[5] == /*link*/ ctx[14] && create_if_block_5(ctx);

	function mouseover_handler(...args) {
		return /*mouseover_handler*/ ctx[10](/*link*/ ctx[14], ...args);
	}
	...
	return {
		...
		h() {
			attr(span, "class", "down-arr svelte-13b5v7h");
			attr(button, "type", "button");
			attr(div, "class", "subnav-container svelte-13b5v7h");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(div, "focus", /*focus_handler*/ ctx[9]),
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if ((!current || dirty & /*site_nav*/ 4) && t0_value !== (t0_value = /*link*/ ctx[14].label + "")) set_data(t0, t0_value);

			if (/*hovered_link*/ ctx[5] == /*link*/ ctx[14]) {
				if (if_block) {
					if_block.p(ctx, dirty);
...
// (164:12) {#if !submenu || !submenu.length}
function create_if_block_4(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-13b5v7h");
			attr(a, "href", a_href_value = /*link*/ ctx[14].url);
			toggle_class(a, "active", /*link*/ ctx[14].url === window.location.pathname);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*site_nav*/ 4 && t_value !== (t_value = /*link*/ ctx[14].label + "")) set_data(t, t_value);

			if (dirty & /*site_nav*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[14].url)) {
...
// (169:16) {#if hovered_link == link}
function create_if_block_5(ctx) {
	let nav;
	let nav_transition;
	let current;
	let each_value_3 = /*submenu*/ ctx[15];
	let each_blocks = [];
	...
	return {
		...
		h() {
			attr(nav, "class", "subnav svelte-13b5v7h");
		},
		m(target, anchor) {
...
// (163:8) {#each site_nav as { link, submenu }}
function create_each_block_2(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (!/*submenu*/ ctx[15] || !/*submenu*/ ctx[15].length) return 0;
		return 1;
	}
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-13b5v7h");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-13b5v7h");
		},
		m(target, anchor) {
			insert_hydration(target, nav, anchor);
...
function create_else_block(ctx) {
	...
	let nav_transition;
	let current;
	let each_value_1 = /*submenu*/ ctx[15];
	let each_blocks = [];
...
// (198:12) {#if !submenu || !submenu.length}
...
// (197:10) {#each site_nav as { link, submenu }}
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-13b5v7h");
			attr(nav, "class", "svelte-13b5v7h");
			attr(div0, "class", "desktop-nav svelte-13b5v7h");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-13b5v7h");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-13b5v7h");
			attr(div2, "class", "section-container svelte-13b5v7h");
			attr(h1, "class", "headline svelte-13b5v7h");
			attr(div3, "class", "section-container svelte-13b5v7h");
			...
			attr(header, "class", "svelte-13b5v7h");
		},
		m(target, anchor) {
